...
function MaleFemaleIcon({ femaleColor, maleColor, className ,props }: { femaleColor?: string, maleColor?: string, className?: string, props?: React.SVGProps<SVGSVGElement> }) {
    return (
        <svg
